...
public class AccountServices
{
    ...
    public async Task UpdateAccount(AccountUpdate accountUpdateModel)
    {
        try
        {
            var response = await _httpClient.PostAsJsonAsync<AccountUpdate>("/MoneyManager/UpdateAccount", accountUpdateModel);
            if (response.IsSuccessStatusCode)
